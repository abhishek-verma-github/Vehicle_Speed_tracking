...
flags.DEFINE_string('image', './highwayss.png', 'path to input image')
...
def main(_argv):
    ...
    t2 = time.time()
    logging.info('time taken by detector: {}'.format(t2 - t1))
    ...
    t4 = time.time()
    logging.info('time taken in cv2:{}'.format(t4-t3))
